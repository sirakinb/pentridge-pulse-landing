...
export const metaConfig = {
  ...
  about: {
    title: "About Pentridge Media | AI Automation Experts | Custom Business Solutions",
    description: "Meet the AI automation experts at Pentridge Media. We've helped 100+ businesses automate processes and scale operations. Learn about our proven methodology and success stories.",
    keywords: "AI automation experts, business automation specialists, Pentridge Media team, AI consulting experts, workflow automation professionals, custom AI development team",
    canonicalUrl: "https://pentridgemedia.com/about",
    pageType: "website"
  },
  
  contact: {
    title: "Contact AI Automation Experts | Pentridge Media | Free Consultation",
    description: "Ready to automate your business? Contact Pentridge Media for a free AI automation consultation. Get custom solutions for workflow automation, CRM systems, and business process optimization.",
  ...
  contentHouse: {
    title: "AI Content Automation Services | Pentridge Media | Automated Content Creation",
  ...
  terms: {
    title: "Terms and Conditions | Pentridge Media | AI Automation Services",
    description: "Terms and conditions for Pentridge Media AI automation services. Read our service agreements, privacy policies, and client responsibilities for business automation projects.",
    keywords: "Pentridge Media terms, AI automation terms, business automation agreement, service terms and conditions, AI consulting terms",
    canonicalUrl: "https://pentridgemedia.com/terms",
    pageType: "website"
  },
  
  privacy: {
    title: "Privacy Policy | Pentridge Media | AI Automation Data Protection",
    description: "Privacy policy for Pentridge Media AI automation services. Learn how we protect your business data and maintain confidentiality in all automation projects and consultations.",
    keywords: "Pentridge Media privacy policy, AI automation privacy, business data protection, automation services privacy, client data security",
    canonicalUrl: "https://pentridgemedia.com/privacy",
    pageType: "website"
  },
  
  seoTest: {
    title: "SEO Test Page | Pentridge Media | Schema Markup Validation",
    description: "Test and validate schema markup implementation for Pentridge Media. Check organization schema, service schema, and FAQ schema for optimal SEO performance.",
  ...
  performanceTest: {
    title: "Performance Test | Pentridge Media - Core Web Vitals & Speed Testing",
    description: "Test and optimize your website performance with Pentridge Media's comprehensive performance testing tools. Monitor Core Web Vitals and page speed metrics.",
    keywords: "performance testing, Core Web Vitals, page speed, website optimization, load time testing, performance metrics, Pentridge Media",
...
export const serviceMetaConfig = {
  aiAutomation: {
    title: "AI Business Automation Services | Custom AI Solutions | Pentridge Media",
  ...
  customAI: {
    title: "Custom AI Development Services | AI Solution Provider | Pentridge Media",
  ...
  webAppDevelopment: {
    title: "AI-Powered Web App Development | Custom App Solutions | Pentridge Media",
  ...
  apiIntegration: {
    title: "API Integration Services | System Integration | Pentridge Media",
  ...
  workflowAutomation: {
    title: "Workflow Automation Solutions | Business Process Automation | Pentridge Media",
  ...
  crmSystems: {
    title: "AI-Powered CRM Systems | Business Management Automation | Pentridge Media",
...
export const industryMetaConfig = {
  legal: {
    title: "Legal Process Automation | Law Firm AI Solutions | Pentridge Media",
  ...
  healthcare: {
    title: "Healthcare Workflow Automation | Medical Practice AI | Pentridge Media",
  ...
  realEstate: {
    title: "Real Estate Automation Solutions | Property Management AI | Pentridge Media",
  ...
  finance: {
    title: "Finance Automation Agency | Financial Services AI | Pentridge Media",
...
// Tool-specific meta configurations
export const toolMetaConfig = {
  make: {
    title: "Make.com Automation Agency | Make.com Workflow Solutions | Pentridge Media",
  ...
  zapier: {
    title: "Zapier Integration Experts | Zapier Automation Services | Pentridge Media",
  ...
  chatgpt: {
    title: "ChatGPT Business Automation | AI Workflow Integration | Pentridge Media",
...
export const getServiceMetaConfig = (serviceKey) => {
  return serviceMetaConfig[serviceKey] || serviceMetaConfig.aiAutomation;
};

// Helper function to get industry meta config
export const getIndustryMetaConfig = (industryKey) => {
  return industryMetaConfig[industryKey] || industryMetaConfig.legal;
};

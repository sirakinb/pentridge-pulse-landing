      ...
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px; width:100%;">
        ...
        <tr><td style="padding-bottom:32px;">
          <p style="margin:0 0 16px; font-size:16px; line-height:1.65; color:rgba(255,255,255,0.6);">
            Thanks for subscribing to Pentridge Media. You'll hear from us when we ship something worth knowing about — new automations, workflow case studies, or product updates from Pentridge Labs.
          </p>
        ...
        <tr><td style="padding-top:32px; padding-bottom:8px;">
          <a href="https://cal.com/akinyemi-bajulaiye-2jua88/30min" style="display:inline-block; padding:14px 28px; background:linear-gradient(90deg,#a855f7,#ec4899); border-radius:9999px; font-family:'Geist',system-ui,sans-serif; font-size:14px; font-weight:500; color:#fff; text-decoration:none;">
...
Book an Automation Audit: https://cal.com/akinyemi-bajulaiye-2jua88/30min

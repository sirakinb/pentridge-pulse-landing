  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#000;">
    <tr><td align="center" class="container" style="padding:56px 24px;">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px; width:100%;">
        ...
        <tr><td style="padding-bottom:32px;">
          <p style="margin:0 0 16px; font-size:16px; line-height:1.65; color:rgba(255,255,255,0.6);">
            Thanks for subscribing to Pentridge. You'll hear from us on becoming AI- and agent-ready, building systems that actually work, and growing your business in this new AI world — drawn from real, in-the-trenches experience, not hype.
          </p>
          <p style="margin:0; font-size:16px; line-height:1.65; color:rgba(255,255,255,0.6);">
            No spam, no daily newsletters, no clickbait. Just real progress.
          </p>
        </td></tr>

        <tr><td style="padding-top:32px; padding-bottom:8px;">
          <a href="https://cal.com/akinyemi-bajulaiye-2jua88/30min?overlayCalendar=true" style="display:inline-block; padding:14px 28px; background:linear-gradient(90deg,#a855f7,#ec4899); border-radius:9999px; font-family:'Geist',system-ui,sans-serif; font-size:14px; font-weight:500; color:#fff; text-decoration:none;">
...
Book a free discovery call: https://cal.com/akinyemi-bajulaiye-2jua88/30min?overlayCalendar=true
